...
reactive_bg_files <- fs::dir_ls(glob = "assets/08-reactivity/reactivity-*", recurse = TRUE)
...
::: fragment
💡 While the app is running, press <kbd>Cmd/Ctrl</kbd> + <kbd>F4</kbd> \
...
![](assets/08-reactivity/make-this-reactive-graph.svg){height="650px"}

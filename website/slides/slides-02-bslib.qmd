...
{{< include ../../_examples/02-bslib/01_app.R >}}
...
::: {.flex-ns .justify-center .items-center}
::: {.w-40}
...
::: {.flex-ns .justify-center .items-center .gap-xs}
...
{{< include ../../_examples/02-bslib/03_app.R >}}
```
:::
...
{{< include ../../_examples/02-bslib/04_app.R >}}

## file: solution.R
{{< include ../../_examples/02-bslib/04_end_app.R >}}
```
...
{{< include ../../_examples/02-bslib/05_app.R >}}
...
{{< include ../../_examples/02-bslib/06_app.R >}}
...
## file: solution.R
{{< include ../../_examples/02-bslib/06_end_app.R >}}
```
...
1. Use `accordion()` and `accordion_panel()` to organize the sidebar inputs.
   See the exercise header for links to search icons.

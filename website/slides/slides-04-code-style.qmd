...
```{.r filename="dplyr/R/across.R" ln-start-from="293"}
...
::: aside
📘 🤓 <https://github.com/tidyverse/dplyr/blob/main/R/across.R#L283-L313>
:::
...
{{< partial ../partials/content-editable-code.html text="* example_" >}}
:::
